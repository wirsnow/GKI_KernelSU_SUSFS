...
以下配置会在同步对应 manifest 后进一步锁定到设备实测的 Google `kernel/common` 提交，其他配置继续使用各自的 manifest 分支：

| 配置 | Google ref | Commit |
|------|------------|--------|
| android13-5.10 / 198 / 2024-01 或 2024-06 | android-14.0.0_r0.130 | 12f3388846c3a8887a607afe1481ccc283455d89 |
| android14-6.1 / 145 / 2025-09 | android14-6.1-2025-09_r22 | fa1d6308d1fe803c3fdebcd3ee6f7a1155fc3462 |

设备的 Android 系统版本不等于内核 KMI。Android 16 的 Pixel 6 如果 `uname -r` 为 `6.1.145-android14-11-*`，仍应在 `kernel-build.yml` 中选择 Android `android14`、Kernel `6.1`。
